...
const api = 'http://restaurant.zoehyh.tw/getPrize';
const errMsg = '請再試一次';
const lottery = {
  name: 'lottery',
...
const lotteryH = document.querySelector('.lottery_heading');
const lotteryRule = document.querySelector('.lottery_rule');
